<?php
/* $Id: czech-windows-1250.inc.php,v 1.158 2003/09/29 12:06:17 nijel Exp $ */
...
$strChangeCopyModeRevoke = ' ... odebrat všechna oprávnìní pùodnímu uivateli a poté ho smazat.';
...
$strDatabasesStatsHeavyTraffic = 'Poznámka: Zobrazení podrobností o&nbsp;databáchích mùe zpùsobit znaèné zvıšení provozu mezi webserverem a MySQL serverem.';
...
$strDeleteAndFlushDescr = 'Toto je nejèistèí øešení, ale naèítání oprávnìní mùe trvat dlouho.';
...
$strNoUsersSelected = 'Nebyl vybrán ádnı uivatel.';
...
$strPrivDescExecute = 'Umonuje spouštìt uloené procedury. V&nbsp;této verzi MySQL se nepouívá.';
...
$strPrivDescProcess3 = 'Umoòuje zabíjet procesy jinım uivatelùm.';
...
$strRevokeGrant = 'Zrušit oprávnìní pøidìlovat práva';
...
$strServerStatusUptime = 'Tento MySQL server beí %s. Èas spuštìní: %s.';
...
$strSimplifiedChinese = 'Zjedodušená Èínština';
$strSingly = '(po jednom)';
$strSize = 'Velikost';
$strSort = 'Øadit';
...
$strTransformation_text_plain__substr = 'Zobrazí jen èást textu. První parametr je posun od zaèátku (vıchozí je 0) a druhı urèuje délku textu, kterı se má zobrazit, pokud není uveden, bude zobrazen zbytek textu. Tøetí parametr uøuje jakı text má bıt pøidán za zkrácenı text (vıchozí je ...).';
...
$strUpgradeMySQL = 'Mìli byste aktualizovat MySQL na verzi %s nebo vyšší.';
$strUsage = 'Pouívá';
...
$strWildcard = 'maska';
$strWindowNotFound = 'Cílové onko prohlíeèe nemohlo bıy aktualizováno. Moná jste zavøel rodièovské okno, nebo prohlíeè blokuje operace mezi okny z dùvodu bezpeènostních nastavení.';
