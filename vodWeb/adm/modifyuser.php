<?php
$link=DBconnect();
$result = mysql_query("SELECT * FROM user WHERE userid='$_GET[uid]'", $link);
...
<table width="550" border="0" align="center" cellspacing="0">
  <tr> 
    <td width="563" bgcolor="#FFFFCC"><div align="center"><font color="#990000" size="+7"><strong>Modify User Information</strong></font></div></td>
  </tr>
</table>
<form name="form1" method="post" action="vod.php?action=adm/saveuser.php&op=2&uid=',$_GET["uid"],'">
  <table width="550" border="1" align="center" cellspacing="0">
    <tr bgcolor="#FFFFCC"> 
      <td colspan="2"><strong><font color="#993300" size="4">Personal Information : </font></strong></td>
    </tr>
    <tr> 
      <td width="196" bgcolor="#FFFFCC"><div align="left"><font color="#996600"><strong>Title : </strong></font></div></td>
      <td width="350"><input name="title" type="text" id="title" value="',$row["title"],'"></td>
    </tr>
    <tr> 
      <td bgcolor="#FFFFCC"><div align="left"><font color="#996600"><strong>Name : </strong></font></div></td>
      <td><input name="name" type="text" id="name" value="',$row["name"],'"></td>
    </tr>
    <tr> 
      <td bgcolor="#FFFFCC"><div align="left"><font color="#996600"><strong>Surname : </strong></font></div></td>
